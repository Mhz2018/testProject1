...
public class RegisterElement {
	...
	private static String EnterpriseName = "input.el-input__inner";//企业名称
	private static String Mailbox = "(//input[@type='text'])[3]";// 邮箱
	private static String MobilePhone="(//input[@type='text'])[4]";// 手机号
	private static String PositionName=("//input[@type='text'])[5]");//职位
	...
	public static WebElement Mailbox(WebDriver driver) {
		...
		return CommonAction.getElementByXpath(driver, Mailbox);
	}

	public static WebElement MobilePhone(WebDriver driver) {
		// 手机号
		
		return CommonAction.getElementByXpath(driver, MobilePhone);
	}

	public static WebElement PositionName(WebDriver driver) {
		// 职位
		return CommonAction.getElementByXpath(driver, PositionName);
	}
